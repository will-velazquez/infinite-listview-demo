...
public sealed partial class WindowTest : Page
{
    ...
    private int _hasBorderOverride;
    ...
    private void Button1_Option_HasTitleBar_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        if (Button1_Option_HasTitleBar.SelectedItem is RadioButton { Content: "true" or "default (True)" })
        {
            Button1_Option_HasBorder.IsEnabled = false;
            this._hasBorderOverride = Button1_Option_HasBorder.SelectedIndex;
            Button1_Option_HasBorder.SelectedIndex = 2;
        }
        else if (Button1_Option_HasTitleBar.SelectedItem is RadioButton { Content: "false" or "default (False)" })
        {
            Button1_Option_HasBorder.SelectedIndex = this._hasBorderOverride;
            this._hasBorderOverride = 0;
            Button1_Option_HasBorder.IsEnabled = true;
        }
    }
    ...
    private void Button1_Click(object sender, RoutedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            contentDialog.PrimaryButtonClick += (_, _) => contentDialog.Hide();
    ...
    private void Button2_Click(object sender, RoutedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            contentDialog.Content = ex.Source;
            contentDialog.PrimaryButtonText = "OK";
            contentDialog.PrimaryButtonClick += (_, _) => contentDialog.Hide();
